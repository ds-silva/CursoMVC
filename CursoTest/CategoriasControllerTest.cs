...
namespace CursoTest
{
    public class CategoriasControllerTest
    {
        ...
        public CategoriasControllerTest()
        {
            ...
            _mockContext.Setup(expression: m => m.Categorias.FindAsync(params keyValues: 1))
                .ReturnAsync(_categoria);
        ...
        public async Task Get_Categoria()
        {
            ...
            var testeCategoria = await service.GetCategoria(id: 1);

            _mockSet.Verify(expression: m => m.FindAsync(params keyValues: 1),
                Times.Once());

            Assert.Equal(expected: _categoria, actual: testeCategoria);
        }
        ...
        public async Task Post_Categoria()
        {
            ...
            _mockContext.Verify(m => m.SaveChangesAsync(It.IsAny<System.Threading.CancellationToken>()),
                Times.Once());
        }
